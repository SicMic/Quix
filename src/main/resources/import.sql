...
INSERT INTO quiz (id, quesito, opzione_uno, opzione_due, opzione_tre, opzione_quattro, data_creazione, categoria_id, raccolta_id) VALUES (13, 'Qual è il continente più grande?', 'Africa', 'Asia', 'America', 'Europa', '2023-07-15', 3, 4);
INSERT INTO quiz (id, quesito, opzione_uno, opzione_due, opzione_tre, opzione_quattro, data_creazione, categoria_id, raccolta_id) VALUES (14, 'Qual è la montagna più alta del mondo?', 'K2', 'Kangchenjunga', 'Everest', 'Lhotse', '2023-07-15', 3, 6);
...
INSERT INTO quiz (id, quesito, opzione_uno, opzione_due, opzione_tre, opzione_quattro, data_creazione, categoria_id, raccolta_id) VALUES (17, 'Quale spezia è nota come oro rosso?', 'Pepe', 'Zafferano', 'Curcuma', 'Paprika', '2023-07-15', 4, 5);
...
INSERT INTO quiz (id, quesito, opzione_uno, opzione_due, opzione_tre, opzione_quattro, data_creazione, categoria_id, raccolta_id) VALUES (20, 'Qual è il metodo di cottura che utilizza l` acqua bollente?', 'Frittura', 'Grigliatura', 'Bollitura', 'Cottura al forno', '2023-07-15', 4, 4);
...
INSERT INTO quiz (id, quesito, opzione_uno, opzione_due, opzione_tre, opzione_quattro, data_creazione, categoria_id, raccolta_id) VALUES (24, 'Qual è il nome della serie TV con i personaggi di "Friends"?', 'How I Met Your Mother', 'The Big Bang Theory', 'Friends', 'New Girl', '2023-07-15', 5, 2);
...
INSERT INTO quiz (id, quesito, opzione_uno, opzione_due, opzione_tre, opzione_quattro, data_creazione, categoria_id, raccolta_id) VALUES (27, 'Qual è il pH neutro?', '0', '7', '14', '10', '2023-07-15', 6, 5);
...
INSERT INTO quiz (id, quesito, opzione_uno, opzione_due, opzione_tre, opzione_quattro, data_creazione, categoria_id, raccolta_id) VALUES (29, 'Qual è il gas più abbondante nell` atmosfera terrestre?', 'Ossigeno', 'Azoto', 'Anidride carbonica', 'Argon', '2023-07-15', 6, 4);
...
INSERT INTO quiz (id, quesito, opzione_uno, opzione_due, opzione_tre, opzione_quattro, data_creazione, categoria_id, raccolta_id) VALUES (37, 'Quale protocollo viene utilizzato per inviare email?', 'HTTP', 'FTP', 'SMTP', 'IMAP', '2023-07-15', 8, 8);
